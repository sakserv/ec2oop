...
DFS_NAME_DIR="/data/01/dfs/nn /data/02/dfs/nn";
...
DFS_DATA_DIR="/data/01/dfs/dn /data/02/dfs/dn";
...
YARN_LOCAL_DIR="/data/01/yarn/nm /data/02/yarn/nm";
...
YARN_LOCAL_LOG_DIR="/data/01/yarn/logs /data/02/yarn/logs";
